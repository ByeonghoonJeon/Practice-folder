# Practice source reference: EDX, Georgia Tech, GTx CS1301xII Computing in Python II: Control Structures
# https://learning.edx.org/course/course-v1:GTx+CS1301xII+1T2021/block-v1:GTx+CS1301xII+1T2021+type@sequential+block@9adaa02afb3143f1a0fa8565084f86bf/block-v1:GTx+CS1301xII+1T2021+type@vertical+block@6f534783f4ff428b98742d01eed5683f
...
for measures in range(1, measures + 1):
    for beats_per_measure in range(1, beats_per_measure + 1):
